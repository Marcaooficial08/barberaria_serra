...
const ServiceItem  = ({service,barbershop,isAuthenticated}: ServiceItemProps) => {
 ...
 const handleBookingSubmit =  async () =>
 {
          ...
          try{
            ...
            const dateMinuetes = Number(hour.split(":")[1])

            const newDate = setMinutes(setHours(date, dateHour), dateMinuetes);
...
// Função para verificar se a data é sexta-feira ou sábado
const isFridayOrSaturday = (date: Date) => {
  const day = date.getDay();
  return day === 5 || day === 6; // sexta-feira = 5, sábado = 6
};
  // Função para desabilitar todas as datas, exceto sexta-feira ou sábado
